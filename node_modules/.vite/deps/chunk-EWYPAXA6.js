import {
  ...
  createCache,
  newStyled
} from "./chunk-EJ562BU4.js";
import {
  _extends,
  _objectWithoutPropertiesLoose,
  require_prop_types
} from "./chunk-KPVRKEXM.js";
import {
  require_jsx_runtime
...
function useRootElementName(parameters) {
  ...
  const [rootElementName, setRootElementName] = React48.useState(rootElementNameProp.toUpperCase());
  if (true) {
    React48.useEffect(() => {
  ...
  const updateRootElementName = React48.useCallback((instance) => {
...
@mui/private-theming/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-EWYPAXA6.js.map
