...
const FreelanceFormulaire = () => {
  ...
  if (role !== 'freelance') {
    return <div>Invalid access to freelance form</div>;
  }
  ...
  const validateField = (name, value) => {
    ...
    switch (name) {
      ...
      case "telephone":
        ...
        } else if (!value && isSignUpMode) {
          error = "Numéro est obligatoire";
        }
        break;
      case "competences":
        if (!value && isSignUpMode) {
          error = "Compétences sont obligatoires";
        } else if (value && value.length < 20) {
          error = "Décrivez vos compétences (min 20 chars)";
        }
        break;
      default:
        break;
  ...
  const handleSignUp = async (e) => {
    ...
    try {
      ...
      navigate("/freelance", { state: { user: response.user } });
    } catch (error) {
      ...
      <div className="forms-container">
        <div className="signin-signup">
          ...
          <form onSubmit={handleSignUp} className="sign-up-form">
            <h2 className="title">Formulaire Freelance</h2>
            {formError && <div className="form-error">{formError}</div>}
            <div className="input-field">
            ...
            <div className="input-field textarea-field">
              ...
              <textarea
                ...
                minLength={20}
              />
              {errors.competences && <span className="field-error">{errors.competences}</span>}
            </div>
